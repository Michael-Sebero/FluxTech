...
public abstract class DefaultProbeInfoProviderMixin {
    ...
    @Redirect(method = "showRF",
              at = @At(
                       ...
                       ordinal = 3))
    private void redirectAddRFInfo(DefaultProbeInfoProvider instance, IProbeInfo probeInfo, ProbeConfig config,
                                   long energy, long maxEnergy, @Local IEnergyStorage handler) {
